...
(lib.下一頁Button = function() {
	this.spriteSheet = ss["chpaba_atlas_"];
	this.gotoAndStop(0);
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/chpaba_atlas_.png", id:"chpaba_atlas_"},
